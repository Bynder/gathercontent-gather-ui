...
var LazyLoad = function (_React$Component) {
  ...
  function LazyLoad(props) {
    ...
    _this.updateViewport = (0, _debounce2.default)(_this.updateViewport.bind(_this), 100);
    return _this;
  }
  ...
  _createClass(LazyLoad, [{
    ...
    value: function updateViewport() {
      ...
      var height = Math.max(documentElement.clientHeight, window.innerHeight || 0);
      var scroll = document.body.scrollTop || documentElement && documentElement.scrollTop;
