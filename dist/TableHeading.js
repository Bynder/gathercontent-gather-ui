...
var _TableHeadingTitle = require('./TableHeadingTitle');

var _TableHeadingTitle2 = _interopRequireDefault(_TableHeadingTitle);

var _Column = require('./Table/Column');
  ...
  _createClass(TableHeading, [{
    ...
    value: function makeSortingColumns() {
      ...
      return this.props.columns.map(function (column, idx) {
        var isActive = _this2.sortingColumnIsActive(column);

        var childClassName = isActive ? 'is-active' : '';
        var columnClassName = _utils2.default.replaceSpacesWithHyphens('table-heading--' + column);
    ...
    value: function sortingColumnIsActive(columnText) {
      return _utils2.default.replaceSpacesWithHyphens(columnText) === this.props.activeSortingProp;
    }
  }, {
...
TableHeading.propTypes = {
  ...
  sortingOrder: _react2.default.PropTypes.number,
  toggleHandler: _react2.default.PropTypes.func,
  sortHandler: _react2.default.PropTypes.func,
  activeSortingProp: _react2.default.PropTypes.string
};
