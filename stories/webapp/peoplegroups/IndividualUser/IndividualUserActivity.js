...
const IndividualUserActivity = ({ activeUser }) => (
  <div className="h-margin-top">
    <div className="h-display-flex h-margin-top-half h-margin-bottom-half">
      <Avatar url={activeUser.url} name={activeUser.name} smallSize />
      <p className={pClasses}>
        {activeUser.name} commented on{' '}
        <a href="google.com">Energy Co. Re-design</a>
        <span className={`${pClasses} neutral-base-text typo-size-slight`}>
          3 hours ago
        </span>
      </p>
    </div>
    <div className="h-display-flex h-margin-top-hald h-margin-bottom-half">
      <Avatar url={activeUser.url} name={activeUser.name} smallSize />
      <p className={pClasses}>
        {activeUser.name} created <a href="google.com">Energy Co. Re-design</a>
        <span className={`${pClasses} neutral-base-text typo-size-slight`}>
          3 hours ago
        </span>
      </p>
