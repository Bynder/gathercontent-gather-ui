  ...
  return (
    <div className={containerClassName}>
      ...
      <input
        ...
        className="pill-input__input h-margin-bottom-quarter h-margin-right-half h-padding-bottom-quarter h-padding-top-quarter h-padding-left-half h-padding-right-half"
        value={inputValue}
