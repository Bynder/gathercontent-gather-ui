...
const ItemInput = () => {
  ...
  const className = cx('item-input__container form__input h-padding-clear', {
  ...
  return (
    <div className={className}>
      ...
      <input
        className="item-input__input h-margin-half h-padding-top-quarter h-padding-bottom-quarter h-padding-top-half h-padding-bottom-half"
        value={inputValue}
