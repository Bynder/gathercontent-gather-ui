...
class MentionsForm extends Component {
  ...
  getMentionsDisplayNames = () => {
    ...
    const displayNames = mentions.split('@');
    const displayNamesWithBlanksRemoved = displayNames.filter(
      displayName => displayName
    );
    return displayNamesWithBlanksRemoved.map(displayName => displayName.trim());
  };
