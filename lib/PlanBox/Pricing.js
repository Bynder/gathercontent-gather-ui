...
const PlanBoxPricing = props => {
  const billingInfo =
    props.priceType === 'priceMonthly' ? '' : 'Billed annually';
    ...
    <div className="plan-box__prices">
      ...
      {props.savings && (
        <div className="plan-box__price plan-box__price--savings">
          Save
          <span className="plan-box__price-text plan-box__price-text--medium">
            {' '}
            <strong>${props.savings}</strong>
          </span>
        </div>
      )}
