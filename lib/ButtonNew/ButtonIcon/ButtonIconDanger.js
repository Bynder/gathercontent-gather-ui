...
function ButtonIconDanger({
  ...
  const classes = cx(
    'p-0 bg-white flex items-center justify-center focus:shadow-red-focus-sm focus:border-red-primary inherit-color-icon text-red-primary border-transparent',
    className,
    {
