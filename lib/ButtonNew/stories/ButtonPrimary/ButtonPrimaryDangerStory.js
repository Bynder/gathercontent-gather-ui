...
storiesOf('Components/Buttons', module).add('ButtonPrimaryDanger', () => (
  <div>
      ...
      >
        <div className="flex flex-wrap">
          ...
          <ButtonStoryItem title="Disabled & loading">
            <ButtonPrimaryDanger size={size} disabled loading>
              Button text
            </ButtonPrimaryDanger>
          </ButtonStoryItem>
          ...
          <ButtonStoryItem title="Disabled Group">
            <ButtonPrimaryDanger size={size} connectedRight disabled>
              Option 1
            </ButtonPrimaryDanger>
            <ButtonPrimaryDanger
              size={size}
            ...
            <ButtonPrimaryDanger size={size} connectedLeft disabled>
              Option 3
            </ButtonPrimaryDanger>
          </ButtonStoryItem>
        </div>
