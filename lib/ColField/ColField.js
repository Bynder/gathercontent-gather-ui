...
function ColField({
  ...
  const classes = cx(
    `col-field shadow border-solid rounded relative transition-all, transition-ease duration-200 ${className}`,
    {
      'bg-white border border-neutral-90': status === statuses.active,
      'bg-neutral-98 border hover:bg-white border-neutral-90':
        status === statuses.unchanged,
      'border-2 border-green-primary bg-green-98': status === statuses.added,
      'border-2 border-red-primary bg-red-98': status === statuses.deleted,
