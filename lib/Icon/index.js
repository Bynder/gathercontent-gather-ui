...
const Icon = props => {
  ...
  const classNames = cx(props.className, {
    ...
    'icon--primary-blue': props.primaryBlue,
    'icon--danger': props.danger
  });

  const textClassNames = cx('icon__text', {
    'icon__text--primary-blue': props.textPrimaryBlue,
    'icon__text--danger': props.textDanger
  });
