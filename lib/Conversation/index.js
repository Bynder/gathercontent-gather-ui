  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {(this.props.resolveConversation || this.props.onSubscribeChange) &&
          comments.length > 0 && (
            <Fragment>
              <div className="conversation__header">
                {this.props.cornerIcon && (
                  <div className="conversation__icon">
                    <Icon name={this.props.cornerIcon} />
                  </div>
                )}
                {this.props.onSubscribeChange && (
                  <CheckToggle
                    displaySmall
                    displayChecked
                ...
                <div className="conversation__resolve">
                  {this.props.resolved && (
                    <span>
                      ...
                      {this.props.handleUndoResolve &&
                        this.props.userCanResolve && (
                          <Button
                            className="conversation__resolve-undo"
                            types={['link-default', 'collapse']}
                            onClick={this.props.handleUndoResolve}
                          >
                            Undo?
                          </Button>
                        )}
