...
class Conversation extends Component {
  ...
  render() {
    ...
    const conversationClasses = (isActive) ? 'conversation--is-active' : '';
    const viewReplyText = `View ${this.props.comments.length - 1} ${pluralize('reply', this.props.comments.length - 1)}`;
