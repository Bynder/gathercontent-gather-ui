...
class BoundaryClickWatcher extends Component {
  static propTypes = {
    initialClickHandler: PropTypes.func,
  ...
  handleClick(event) {
    const targetIsCounter = event.target !== this.container;
    ...
    const userHasClickedOutside = targetIsCounter && containerDoesNotContainTarget && containerDoesNotContainFocus;
