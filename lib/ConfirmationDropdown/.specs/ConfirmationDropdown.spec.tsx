...
describe("ConfirmationDropdown", () => {
  it("Calls the confirmation promise and sets the correct state whilst pending", () => new Promise<void>(async (done) => {
    ...
    render(
      <ConfirmationDropdown
        ...
        onHide={() => {}}
        dropdownContent={
          <div className="confirmation-dropwdown__content">
            Dropdown content
          </div>
        }
        isDanger
    ...
    expect(screen.getByTestId('confirmation-dropdown').parentElement?.classList.contains('is-pending'));
