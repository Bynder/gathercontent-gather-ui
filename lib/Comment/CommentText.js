...
function BlurBottom() {
  return (
    <span className="comment-blur-bottom absolute h-8 w-full top-0 left-0 mt-24 bg-blur-white-bottom conversation__text__cutoff" />
  );
}

function CommentText({ children, users, showFullText, currentUser }) {
