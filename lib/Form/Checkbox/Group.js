...
export default class Group extends Component {
  ...
  constructor(props) {
    ...
    this.state = { choices: props.choices, selected, highlightHover: false };
    this.onChangeHandler = this.onChangeHandler.bind(this);
    this.removeChoice = this.removeChoice.bind(this);
    this.addChoice = this.addChoice.bind(this);
    this.highlightIsHovered = this.highlightIsHovered.bind(this);
    this.highlightIsNotHovered = this.highlightIsNotHovered.bind(this);
  }
      ...
      <div>
        {this.state.choices.map(choice => (
          <Checkbox
            ...
            highlightIsHovered={this.highlightIsHovered}
            highlightIsNotHovered={this.highlightIsNotHovered}
